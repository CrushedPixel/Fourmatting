...
public abstract class GenericFourmatter<T, B> implements Fourmatter<T> {
     ...
     */
    private final BiFunction<B, T, B> append;
    ...
    public GenericFourmatter(Supplier<B> create, Function<String, T> fromString,
        ...
        this(create, fromString, append, new Random()::nextInt, build);
    }

    public GenericFourmatter(Supplier<B> create, Function<String, T> fromString,
                             BiFunction<B, T, B> append, Function<Integer, Integer> random,
                             Function<B, T> build) {
        this.create = create;
